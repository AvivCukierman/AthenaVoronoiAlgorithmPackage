...
ToolSvc += CfgMgr.VoronoiWeightTool("MyVoronoiTool",doSpread=False,nSigma=0)
ToolSvc += CfgMgr.JetConstituentModSequence("MyJetConstituentModSequence",InputContainer="CaloCalTopoClusters",OutputContainer="VoronoiClusters",InputType="CaloCluster",Modifiers=[ToolSvc.MyVoronoiTool])
...
#xaodStream.AddAcceptAlgs( "MyCompletePackageAlg" ) #will only keep events where 'setFilterPassed(false)' has NOT been called in the given algorithm
